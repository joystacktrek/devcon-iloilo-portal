...
import { idlFactory } from './devcon-iloilo-portal.did.js';
export { idlFactory } from './devcon-iloilo-portal.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DEVCON_ILOILO_PORTAL;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./devcon-iloilo-portal.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the devcon-iloilo-portal canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./devcon-iloilo-portal.did.js")._SERVICE>}
 */
export const devcon_iloilo_portal = createActor(canisterId);
